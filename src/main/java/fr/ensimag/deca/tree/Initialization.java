...
public class Initialization extends AbstractInitialization {
    ...
    @Override
    protected void optimizeInitialization(DecacCompiler compiler, EnvironmentVarValue envVar) throws ContextualError {
        this.setExpression(getExpression().optimizeExp(compiler,envVar));
    }
